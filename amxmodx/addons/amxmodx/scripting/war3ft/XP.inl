...
public bomb_defusing( defuser )
{
	...
	if ( !bHasBegunPlantingOrDefusing[defuser] )
	{
		...
		if ( iBonusXP != 0 )
		{
			client_print( defuser, print_chat, "%s 你因为着手拆除C4而被奖励 %d XP！", g_MODclient, iBonusXP );
		}
	}
...
public bomb_defused( defuser )
{
	...
	if ( iBonusXP != 0 )
	{
		client_print( defuser, print_chat, "%s 你因为成功拆除C4而被奖励 %d XP！", g_MODclient, iBonusXP );
	}
...
public bomb_planting( planter )
{
	...
	if ( !bHasBegunPlantingOrDefusing[planter] )
	{
		...
		if ( iBonusXP != 0 )
		{
			client_print( planter, print_chat, "%s 你因为着手放置C4而被奖励 %d XP！", g_MODclient, iBonusXP );
		}
	}
...
public bomb_planted( planter )
{
	...
	if ( iBonusXP != 0 )
	{
		client_print( planter, print_chat, "%s 你因为成功放置C4而被奖励 %d XP！", g_MODclient, iBonusXP );
	}
...
public on_PlayerAction()
{
	...
	if (equal(sAction,"Spawned_With_The_Bomb"))
	{
		...
		{
			client_print( id, print_chat, "%s 你因为开局时携带C4而被奖励 %d XP！", g_MODclient, iBonusXP );
		}
	}
	// Dropped bomb 
	else if (equal(sAction,"Dropped_The_Bomb"))
	{
		...
		if ( iBonusXP != 0 && get_pcvar_num( CVAR_wc3_show_objectives ) )
		{
			client_print( id, print_chat, "%s 你因为丢弃C4而被扣除 %d XP！", g_MODclient, -1 * iBonusXP );
		}
	}
	// Picked up bomb 
	...
	{ 
		...
		if ( iBonusXP != 0 && get_pcvar_num( CVAR_wc3_show_objectives ) )
		{
			client_print( id, print_chat, "%s 你因为捡起C4而被奖励 %d XP！", g_MODclient, iBonusXP );
		}
	}
	// Hostage touched 
	else if (equal(sAction,"Touched_A_Hostage"))
	{
		...
		if ( iBonusXP != 0 && get_pcvar_num( CVAR_wc3_show_objectives ) )
		{
			client_print( id, print_chat, "%s 你因为着手营救人质而被奖励 %d XP！", g_MODclient, iBonusXP );
		}
	}
	// Hostage rescued 
	else if (equal(sAction,"Rescued_A_Hostage"))
	{
		...
		if ( iBonusXP != 0 && get_pcvar_num( CVAR_wc3_show_objectives ) )
		{
			client_print( id, print_chat, "%s 你因为成功营救人质而被奖励 %d XP！", g_MODclient, iBonusXP );
		}
	}
	// Hostage killed 
	else if (equal(sAction,"Killed_A_Hostage"))
	{
		...
		if ( iBonusXP != 0 && get_pcvar_num( CVAR_wc3_show_objectives ) )
		{
			client_print( id, print_chat, "%s 你因为杀害人质而被扣除 %d XP！", g_MODclient, -1 * iBonusXP );
		}
	}
	// VIP spawn 
	...
	{ 
		...
		if ( iBonusXP != 0 && get_pcvar_num( CVAR_wc3_show_objectives ) )
		{
			client_print( id, print_chat, "%s 你因为开局时是VIP而被奖励 %d XP！", g_MODclient, iBonusXP );
		}
	}
	// VIP escaped 
	else if (equal(sAction,"Escaped_As_VIP"))
	{
		...
		if ( iBonusXP != 0 && get_pcvar_num( CVAR_wc3_show_objectives ) )
		{
			client_print( id, print_chat, "%s 你作为VIP因为成功脱逃而被奖励 %d XP！", g_MODclient, iBonusXP );
		}
	}
}
...
XP_onDeath( iVictim, iAttacker, iWeaponIndex, iHeadshot )
{
	...
	if ( get_user_team( iAttacker ) == get_user_team( iVictim ) )
	{
		...
		if ( iBonusXP != 0 )
		{
			client_print( iAttacker, print_chat, "%s 你因为杀害队友而被扣除 %d XP！", g_MODclient, -1 * iBonusXP );
		}
	...
	else
	{
		...
		{
			client_print( iAttacker, print_chat, "%s 你因为杀死了敌人而被奖励 %d XP！", g_MODclient, iBonusXP );
		}
		...
		if ( iHeadshot )
		{
			...
			if ( iBonusXP != 0 && get_pcvar_num( CVAR_wc3_show_kill_obj ) )
			{
				client_print( iAttacker, print_chat, "%s 你因为把敌人爆头了而被奖励 %d XP！", g_MODclient, iBonusXP );
			}
		}
		...
		for ( new i = 0; i < MAXPLAYERS; i++ )
		{
			...
			if ( g_iDamageDealt[i][iVictim] > 0 && iAttacker != i )
			{
				...
				if ( iBonusXP != 0 && get_pcvar_num( CVAR_wc3_show_kill_obj ) )
				{
					client_print( i, print_chat, "%s 你因为协助队友杀死了敌人而被奖励 %d XP！", g_MODclient, iBonusXP );
				}
		...
		if ( g_MOD == GAME_CSTRIKE || g_MOD == GAME_CZERO )
		{
			...
			if ( g_iPlayerRole[iVictim] == PLR_HOSTAGE_RESCUER )
			{
				...
				if ( iBonusXP != 0 && get_pcvar_num( CVAR_wc3_show_kill_obj ) )
				{
					client_print( iAttacker, print_chat, "%s 你因为杀死了营救人质的CT而被奖励 %d XP！", g_MODclient, iBonusXP );
				}
			}
			...
			else if ( g_iPlayerRole[iVictim] == PLR_BOMB_DEFUSER )
			{
				...
				if ( iBonusXP != 0 && get_pcvar_num( CVAR_wc3_show_kill_obj ) )
				{
					client_print( iAttacker, print_chat, "%s 你因为杀死了拆弹者而被奖励 %d XP！", g_MODclient, iBonusXP );
				}
			}
			...
			else if ( g_iPlayerRole[iVictim] == PLR_BOMB_PLANTER )
			{
				...
				if ( iBonusXP != 0 && get_pcvar_num( CVAR_wc3_show_kill_obj ) )
				{
					client_print( iAttacker, print_chat, "%s 你因为杀死了埋包者而被奖励 %d XP！", g_MODclient, iBonusXP );
				}
			}
			...
			else if ( g_iPlayerRole[iVictim] == PLR_BOMB_CARRIER )
			{
				...
				if ( iBonusXP != 0 && get_pcvar_num( CVAR_wc3_show_kill_obj ) )
				{
					client_print( iAttacker, print_chat, "%s 你因为杀死了C4携带者而被奖励 %d XP！", g_MODclient, iBonusXP );
				}
			}
			// user killed the VIP
			else if ( g_iPlayerRole[iVictim] == PLR_VIP )
			{
				...
				if ( iBonusXP != 0 && get_pcvar_num( CVAR_wc3_show_objectives ) )
				{
					client_print( iAttacker, print_chat, "%s 你因为杀死了VIP而被奖励 %d XP！", g_MODclient, iBonusXP );
				}
			}
		}
